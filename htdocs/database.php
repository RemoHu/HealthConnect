...
// Database Connection
$link = mysql_connect('localhost', 'root', 'Istanbul2016');
if (!$link) {
...
$selected = mysql_select_db("bitnami_wordpress", $link)
...
// --------------For Aliments----------------
// For Alcohol
$sql = "SELECT * FROM wp_swpm_members_tbl where address_street is not null";
$result = mysql_query($sql);
...
// For Cancer
$sql = "SELECT * FROM wp_swpm_members_tbl where address_city is not null";
$result = mysql_query($sql);
...
// For Diabetes
$sql = "SELECT * FROM wp_swpm_members_tbl where address_state is not null";
$result = mysql_query($sql);
...
// For Drug abuse
$sql = "SELECT * FROM wp_swpm_members_tbl where address_zipcode is not null";
$result = mysql_query($sql);
...
// For Obesity
$sql = "SELECT * FROM wp_swpm_members_tbl where company_name is not null";
$result = mysql_query($sql);
...
<html>
  ...
  <body>
	<div style="float:right; margin-right:50px; margin-top:10px">
		<a href="http://health-connect-dev.australiasoutheast.cloudapp.azure.com/wordpress/report_logout.php">Logout</a>
	</div>
	...
	<div align=center>
		...
		<h2>Health Connect User Report</h2>
		...
		<p><font size="4">Amount of Registed Users By Month (<?php echo $current_year?>)</font></p>
		...
		<p><font size="4">Total Number of Users with respect to Ailment</font></p>
		...
		<p><font size="4">Total Number of Users with respect to Territory</font></p>
		...
		<p><font size="4">Total Number of Users with respect to Gender</font></p>
		...
		<p><font size="4">Total Number of Users with respect to Age Group</font></p>
