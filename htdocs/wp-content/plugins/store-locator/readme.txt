...
* [addon] [Super Geocoder](http://docs.viadat.com/Super_Geocoder) - update: adjusted for properly showing geocoded locations change from red to white in real time
* v3.97.1 - admin notice/msg handling

= 3.96 =
* Upgraded - Google Maps outside script conflict management
* New logic for interface display
* [addon] [CSV Importer/Exporter](http://docs.viadat.com/CSV_Importer_Geocoder_Exporter_XML_Exporter) - update: added clause checking for version to determine whether to mod URL once

= 3.95 =
* Update to tags string prepping function for HTML entity management
* Remove $_POST clause from sl_admin_form_post hook
* [addon] [CSV Importer/Exporter G2](http://docs.viadat.com/CSV_Importer_Exporter_G2) - update: Improved CSV file creation process during export and workflow during import
...
= 3.94 =
* [addon] [CSV Importer/Exporter](http://docs.viadat.com/CSV_Importer_Geocoder_Exporter_XML_Exporter) - added date timestamp info to temp file created during import process
* [addon] [CSV Importer/Exporter](http://docs.viadat.com/CSV_Importer_Geocoder_Exporter_XML_Exporter) - Auto-adjusts admin message
...
* [addon] [Multiple-Field Updater G2](http://docs.viadat.com/Multiple_Field_Updater_G2) - interface updates; more seamless with latest WP stylings
...
= 3.90.x =
* [addon] [Multiple Mapper](http://docs.viadat.com/Multiple_Mapper) - update to string-handling/processing functionality
* [addon] [CSV Importer/Exporter](http://docs.viadat.com/CSV_Importer_Geocoder_Exporter_XML_Exporter) - update to CSV-processing workflow
* [addon] [Categorizer](http://docs.viadat.com/Categorizer) - Added helpful admin notice for after-activation for select installs
