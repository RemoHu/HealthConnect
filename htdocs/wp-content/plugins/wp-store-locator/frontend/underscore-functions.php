...
<script id="wpsl-listing-template" type="text/template">
    <?php
        ...
        if ( $wpsl_settings['show_contact_details'] ) {
            ...
            $listing_template .= "\t\t\t" . '<span><strong>' . esc_html( $wpsl->i18n->get_translation( 'fax_label', __( 'Beds', 'wpsl' ) ) ) . '</strong>: <%= fax %></span>' . "\r\n";
            $listing_template .= "\t\t\t" . '<% } %>' . "\r\n";
    ...
    if ( $wpsl_settings['more_info'] ) {
        ...
        if ( $wpsl_settings['more_info_location'] == 'store listings' ) {
            ...
            if ( !$wpsl_settings['show_contact_details'] ) {
                ...
                $more_info_template .= "\t\t\t\t" . '<span><strong>' . esc_html( $wpsl->i18n->get_translation( 'fax_label', __( 'Beds', 'wpsl' ) ) ) . '</strong>: <%= fax %></span>' . "\r\n";
                $more_info_template .= "\t\t\t\t" . '<% } %>' . "\r\n";
