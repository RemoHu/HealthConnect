    ...
    <script type="text/javascript">
      ...
      function drawChart() {
        var data = google.visualization.arrayToDataTable([
          ['Age Group', 'Alchohol', 'Drugs', 'Cancer', 'Obesity'],
          ['0-14', 1000, 400, 200, 100],
          ['15-24', 1170, 460, 250, 800],
          ['25-34', 660, 1120, 300, 900],
          ['35-44', 1030, 540, 350, 700],
		  ['45-54', 344, 500, 400, 600],
		  ['55-64', 800, 600, 700, 200],
		  ['65-74', 500, 700, 800, 100],
		  ['Over 75', 600, 200, 1000, 100]
        ]);

        var options = {
          chart: {
            title: 'Ailments Statistics',
            subtitle: '2014-2017',
          },
  ...
  <body>
    <div style="float: left;" id="donutchart1" style="width: 400px; height: 200px;"></div>
	<div style="float: left;" id="donutchart2" style="width: 400px; height: 200px;"></div>
	<div style="float: left;" id="donutchart3" style="width: 400px; height: 200px;"></div>
	<div style="float: left;" id="donutchart4" style="width: 400px; height: 200px;"></div>
  </body>
  <br>
